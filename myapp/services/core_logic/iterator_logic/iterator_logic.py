from .iterator_logic_interface import BaseIteratorLogic
from myapp.services.core_logic.iterator_attribute_manager.attribute_manager import AttributeManager
